...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop 'CACHE'Project server (and possibly override the detachdb config value).");
...
{ //  name                               function                          safemd  unlocked
  //  ------------------------           -----------------------           ------  --------
    ...
    { "fixerrorgetbalancefunction",      &fixerrorgetbalancefunction,      false,  false },
    { "getreceivedbyaddress",            &getreceivedbyaddress,            false,  false },
    { "getreceivedbyaddressother",       &getreceivedbyaddressother,       false,  false },
    { "getreceivedbyaccount",            &getreceivedbyaccount,            false,  false },
    { "getreceivedbyaccountother",       &getreceivedbyaccountother,       false,  false },
    ...
    { "getbalanceother",                 &getbalanceother,                 false,  false },
    ...
    { "totaltokensforalladdresses",      &totaltokensforalladdresses,      false,  false },
    { "totalsenttokensinalladdresses",   &totalsenttokensinalladdresses,   false,  false },
    { "getbalanceallitsaddresses",       &getbalanceallitsaddresses,       false,  false },
    { "getmintbalanceinalladdresses",    &getmintbalanceinalladdresses,    false,  false },
    { "getminebalanceinalladdresses",    &getminebalanceinalladdresses,    false,  false },
    ...
    { "listaddressgroupingsother",       &listaddressgroupingsother,       false,  false },
    ...
    { "importprivkeyfast",               &importprivkeyfast,               false,  false },
...
string HTTPPost(const string& strMsg, const map<string,string>& mapRequestHeaders)
{
    ostringstream s;
    s << "POST / HTTP/1.1\r\n"
      << "User-Agent: cacheproject-json-rpc/" << FormatFullVersion() << "\r\n"
      << "Host: 127.0.0.1\r\n"
...
static string HTTPReply(int nStatus, const string& strMsg, bool keepalive)
{
    if (nStatus == HTTP_UNAUTHORIZED)
        return strprintf("HTTP/1.0 401 Authorization Required\r\n"
            "Date: %s\r\n"
            "Server: cacheproject-json-rpc/%s\r\n"
