...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        (331880, uint256("0x0000001dbc3a9beefeedfd077d0d508c7c343256b24609bf6e72b88d6298c823"))
        ;
    ...
    bool AcceptPendingSyncCheckpoint()
    {
        ...
        if (hashPendingCheckpoint != 0 && mapBlockIndex.count(hashPendingCheckpoint))
        {
            ...
            if (!pindexCheckpoint->IsInMainChain())
            {
                ...
                if (!block.SetBestChain(state, txdb, pindexCheckpoint, false))
                {
    ...
    bool ResetSyncCheckpoint(uint256 hashExternal, bool fUseMap)
    {
        ...
        if (mapBlockIndex.count(hash) && !mapBlockIndex[hash]->IsInMainChain())
        {
            ...
            CValidationState state;
            if (!block.SetBestChain(state, txdb, mapBlockIndex[hash], false))
            {
