...
public:
    ...
    bool CommitTransaction(CWalletTx& wtxNew, CReserveKey& reservekey, int &nNumberOfThisError, std::string &strError);
...
public:
    ...
    bool AcceptWalletTransaction(CValidationState& state, CTxDB& txdb, bool fCheckInputs=true);
